...
### QR pill assets\r
\r
Every QR-pill state uses \`src/assets/qr.svg\`, including the base icon and the glow layer. Committed copyable \`known\` and \`unknown\` states retain the subtle inherited-color 4.5-second full-icon glow; the artwork never switches to \`copyqr.svg\`. The full pill copies the payload, and provisional values remain non-copyable.
\r
...
//# sourceMappingURL=emulator-fullscreen-D7zzNVWB.js.map
