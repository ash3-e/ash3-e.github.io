...
$docSpecs = @(
  ...
  [ordered]@{ slug = "cfg"; file = "docs/bcode-cfg-v0.html"; display_title = "BCODe.cfg"; preview_title = "bcode-cfg-v0" }
...
$output = @"
window.__TREE_DOCS_DATA__ = $docsJson;
window.__TREE_READER_SECTIONS__ = $sectionsJson;
"@

[System.IO.File]::WriteAllText((Join-Path $root "assets/tree-docs-data.js"), $output, $utf8NoBom)
